...
class TextToSpeechDataSource {
  ...
  final _ttsProgressController = StreamController<Map<String, dynamic>>.broadcast();
  ...
  Stream<Map<String, dynamic>> get onTtsProgress => _ttsProgressController.stream;
  ...
  Future<void> initialize() async {
    if (!_initialized) {
      ...
      _initialized = true;
      print('Text-to-speech initialized successfully with enhanced quality settings');
    }
  }
  ...
  Future<List<dynamic>> getAvailableVoices(String languageCode) async {
    ...
    final filteredVoices = voiceList
  ...
  Future<void> _setBestVoiceForLanguage(String languageCode) async {
    ...
    if (preferredVoice != null) {
      ...
      print('Set high-quality voice: ${preferredVoice["name"]} for $languageCode');
    }
  }
